...
class CrystalGraphConvNet(nn.Module):
    def __init__(self, orig_atom_fea_len, nbr_fea_len,
        ...
        # Extra feature processing with batch normalization
        # Dynamically adjust the input size based on number of features
        ...
        if n_h > 1:
            ...
            self.bns = nn.ModuleList([nn.BatchNorm1d(h_fea_len)
                                    for _ in range(n_h-1)])
